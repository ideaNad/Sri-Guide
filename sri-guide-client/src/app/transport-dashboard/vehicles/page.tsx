                        ...
                        >
                            <div className="aspect-[16/9] bg-gray-100 relative overflow-hidden">
                                {vehicle.vehicleImageUrl ? (
                                    <img 
                                        src={vehicle.vehicleImageUrl.startsWith("/") ? `${apiClient.defaults.baseURL?.replace('/api', '')}${vehicle.vehicleImageUrl}` : vehicle.vehicleImageUrl} 
                                ...
                                <div className="absolute top-4 left-4 z-10">
                                    <span className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg backdrop-blur-md border border-white/20 ${
                                        vehicle.isAvailable 
