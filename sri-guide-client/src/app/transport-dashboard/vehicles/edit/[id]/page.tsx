    ...
    if (isLoading) {
        return (
            <div className="min-h-[50vh] flex items-center justify-center">
                <p className="text-gray-400 font-black uppercase tracking-widest animate-pulse flex items-center gap-3">
    ...
    if (!vehicle) {
        return (
            <div className="text-center py-20 space-y-4">
                <h1 className="text-3xl font-black text-gray-900 uppercase">Vehicle Not Found</h1>
                <Link href="/transport-dashboard/vehicles" className="text-blue-600 font-bold hover:underline">Return to fleet</Link>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <header className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tight">Edit Vehicle</h1>
                    <p className="text-gray-500 font-medium">Update specification for your {vehicle.brand} {vehicle.model}.</p>
                </div>
            </header>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pb-6 border-b border-blue-100/30">
                            ...
                            <div className="p-6 bg-green-50/50 rounded-[2rem] border border-green-100/50">
                                <label className="flex items-center gap-4 cursor-pointer select-none">
                                    ...
                                    <div>
                                        <span className="block text-sm font-black text-gray-900 uppercase tracking-tight">Vehicle Availability</span>
                                        <span className="text-[10px] font-bold text-green-600 uppercase tracking-widest">Toggle visibility for booking inquiries</span>
                                    </div>
                                </label>
                            </div>
