...
export default function TransportSearchPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50">
            {/* Hero Section */}
            <section className="bg-gray-900 text-white pt-32 pb-20 px-6 relative overflow-hidden">
                ...
                <div className="max-w-[1600px] mx-auto relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-6xl font-black mt-6 leading-tight uppercase tracking-tight">
                            Find the Perfect <br />
            ...
            <div className="max-w-[1600px] mx-auto px-6 -mt-10 relative z-20">
                <div className="bg-white p-4 md:p-6 rounded-[2.5rem] shadow-2xl shadow-gray-200/50 flex flex-col md:flex-row items-center gap-4">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 px-8 py-5 bg-blue-50 text-blue-600 rounded-3xl font-black uppercase tracking-tight hover:bg-blue-100 transition-all disabled:opacity-50 group"
                    >
                    ...
                    <button className="hidden md:flex items-center gap-2 px-10 py-5 bg-gray-900 text-white rounded-3xl font-black uppercase tracking-tight hover:bg-black transition-all shadow-lg shadow-gray-900/10">
                        <Search size={20} />
                        <span>Search</span>
                    </button>
                </div>
                ...
                <aside className="space-y-8">
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm sticky top-32">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            {(vehicleType || capacity || driverIncluded !== null || hasAc !== null) && (
                                <button 
                                    onClick={() => { 
                                        setVehicleType(''); 
                                        setCapacity(''); 
                        ...
                        <div className="space-y-6">
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {['car', 'van', 'bus', 'tuk', 'jeep'].map((type) => (
                                        <button 
                                            key={type}
                                            onClick={() => setVehicleType(vehicleType === type ? '' : type)}
                                            className={`py-3 rounded-xl font-bold text-xs uppercase tracking-tight transition-all border ${
                                                vehicleType === type 
                            ...
                            <div className="space-y-3">
                                ...
                                <select 
                                    className="w-full bg-gray-50 border-none rounded-xl py-3 px-4 text-xs font-black uppercase tracking-tight focus:ring-2 focus:ring-blue-500/10 outline-none"
                                    value={capacity}
