...
const CreateTourPage = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        itinerary: [
            { time: "08:00 AM", title: "Meeting Point", description: "Standard meeting point collection", imageUrl: "", dayNumber: 1, order: 1 }
        ]
    });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            alert("Failed to publish adventure. Please check the highlights and try again!");
        } finally {
            setLoading(false);
        }
    };
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                                                        <div className="md:col-span-4 space-y-4">
                                                            <div className="space-y-2">
                                                                <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Timing</label>
                                                                <input 
                                                                    type="time" 
                                                                    value={item.time} 
                                                                    onChange={e => {
                                                        ...
                                                        <div className="md:col-span-7 space-y-4">
                                                            <div className="space-y-2">
                                                                <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Activity Title</label>
                                                                <input 
                                                                    type="text" 
                                                                    value={item.title} 
                                                                    onChange={e => {
                                                            ...
                                                            <div className="space-y-2">
                                                                <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Highlights</label>
                                                                <textarea 
                                                                    rows={3}
