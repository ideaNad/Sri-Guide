                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="flex items-center gap-4 bg-gray-50 p-6 rounded-[2rem] border border-gray-100 w-fit">
                                        ...
                                        <button
                                            ...
                                            className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${formData.isActive ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/20' : 'bg-white text-gray-400 border border-gray-100'
                                                }`}
                                        >
